...
public class JobAdvertisementManager implements JobAdvertisementService{
	...
	@Override
	public DataResult<List<JobAdvertisement>> getByEmployer_CompanyNameAndIsActive(String employerName) {
		return new SuccessDataResult<List<JobAdvertisement>>(this.jobAdvertisementDao.getByCompanyNameAndIsActive(employerName), "Data getirildi." );
	}
	...
	public DataResult<JobAdvertisement> getById(int id) {
		return new SuccessDataResult<JobAdvertisement>(this.jobAdvertisementDao.getById(id),"Data getirildi.");
	}

	@Override
	public Result updateHrmsStaffConfirmation(int id, boolean hrmsStaffConfirm) {
		
		JobAdvertisement jobAdvertisementupdateHrmsStaffConfirmation = this.jobAdvertisementDao.findById(id).get();
		jobAdvertisementupdateHrmsStaffConfirmation.setHrmsStaffConfirmation(hrmsStaffConfirm);
		this.jobAdvertisementDao.save(jobAdvertisementupdateHrmsStaffConfirmation);
		return new SuccessResult("Hrms onayı alindi.");
	}
